...
mixin NavigationMixin {
  ...
  void goToVehicleInputDetails() => _navigationService.navigateTo(Routes.enterVehicleDetailsView); 
  void goToDeliveryVehicleDetails() => _navigationService.navigateTo(Routes.deliveryVehicleDetailsView); 
  void goToAllocatedView() => _navigationService.navigateTo(Routes.allocatedView); 
