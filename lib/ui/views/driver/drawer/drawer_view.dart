...
class DrawerDriverView extends ViewModelWidget<DriverViewModel> {
  const DrawerDriverView({super.key});
  ...
  Widget buildMenuItems(BuildContext context, DriverViewModel viewModel) => Column(
        children: [
          ListTile(
